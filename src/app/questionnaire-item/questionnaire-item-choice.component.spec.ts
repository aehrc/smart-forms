...
describe('QuestionnaireItemChoiceComponent', () => {
  ...
  it('should be displayed as a radio button', () => {
    ...
    answerOption: [
      ...
      {
        "valueCoding": {
          "code": "NA", "display": "NA", "system": "http://terminology.hl7.org/CodeSystem/v3-NullFlavor"
        },
      },
    ]
  };
  ...
  it('should be displayed as a dropdown', () => {
    ...
    item: [],
      answerOption: [
        {
          "valueCoding": {
            "code": "1", "display": "Aboriginal but not Torres Strait Islander origin", "system": "https://healthterminologies.gov.au/fhir/CodeSystem/australian-indigenous-status-1"
          }
        }, 
        {
          "valueCoding": {
            "code": "2", "display": "Torres Strait Islander but not Aboriginal origin", "system": "https://healthterminologies.gov.au/fhir/CodeSystem/australian-indigenous-status-1"
          }
        },
        {
          "valueCoding": {
            "code": "3", "display": "Both Aboriginal and Torres Strait Islander origin", "system": "https://healthterminologies.gov.au/fhir/CodeSystem/australian-indigenous-status-1"
          }
        },
        {
          "valueCoding": {
            "code": "4", "display": "Neither Aboriginal nor Torres Strait Islander origin", "system": "https://healthterminologies.gov.au/fhir/CodeSystem/australian-indigenous-status-1"
          }
        },
        {
          "valueCoding": {
            "code": "9", "display": "Not stated/inadequately described", "system": "https://healthterminologies.gov.au/fhir/CodeSystem/australian-indigenous-status-1"
          }
        }]
    };    
    fixture.detectChanges();
