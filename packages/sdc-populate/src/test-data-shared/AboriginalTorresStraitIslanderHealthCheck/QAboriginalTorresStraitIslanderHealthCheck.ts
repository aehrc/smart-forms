...
export const QAboriginalTorresStraitIslanderHealthCheck: Questionnaire = {
  resourceType: 'Questionnaire',
  id: 'AboriginalTorresStraitIslanderHealthCheck',
  meta: {
    versionId: '1',
    lastUpdated: '2025-07-30T13:57:51.938+00:00',
    source: '#Prx4cmc71ByV9bUZ'
  },
  contained: [
    {
                ...
                extension: [
                  {
                    url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
                    valueString:
                      "item.where(linkId='e4524654-f6de-4717-b288-34919394d46b').answer.value.toDateTime()"
                  }
                ]
              }
            },
              ...
              extension: [
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractContext',
                  valueString:
                    "item.where(linkId='allergynew-manifestation').answer.value.ofType(string)"
                }
              ],
              _text: {
                extension: [
                    ...
                    extension: [
                      {
                        url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
                        valueString:
                          "item.where(linkId='allergysummary-status').answer.value.first()"
                      }
                    ]
                  }
                ]
        ...
        extension: [
          {
            url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
            valueString:
              "%resource.repeat(item).where(linkId='substanceuse-smoking-smokingstatus-group-newdate').answer.value.toDateTime()"
          }
        ]
      },
      valueCodeableConcept: {
    ...
    },
    {
      ...
      experimental: false,
      description:
        'The Heart Rhythm value set includes values that may be used to represent the heart rhythm of an individual.',
      compose: {
        include: [
          {
            system: 'http://snomed.info/sct',
        ...
        extension: [
          {
            url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
            valueString:
              "%resource.repeat(item).where(linkId='obs-height-newdate').answer.value.toDateTime()"
          }
        ]
      },
      valueQuantity: {
        ...
        extension: [
          {
            url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
            valueString:
              "%resource.repeat(item).where(linkId='obs-lengthheight-newdate').answer.value.toDateTime()"
          }
        ]
      },
      valueQuantity: {
        ...
        extension: [
          {
            url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
            valueString:
              "%resource.repeat(item).where(linkId='obs-weight-newdate').answer.value.toDateTime()"
          }
        ]
      },
      valueQuantity: {
        ...
        extension: [
          {
            url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
            valueString:
              "%resource.repeat(item).where(linkId='obs-waistcircumference-newdate').answer.value.toDateTime()"
          }
        ]
      },
      valueQuantity: {
        ...
        extension: [
          {
            url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
            valueString:
              "%resource.repeat(item).where(linkId='obs-headcircumference-newdate').answer.value.toDateTime()"
          }
        ]
      },
      valueQuantity: {
        ...
        extension: [
          {
            url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
            valueString:
              "%resource.repeat(item).where(linkId='obs-heartrate-newdate').answer.value.toDateTime()"
          }
        ]
      },
      valueQuantity: {
        ...
        extension: [
          {
            url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
            valueString:
              "%resource.repeat(item).where(linkId='obs-heartrhythm-newdate').answer.value.toDateTime()"
          }
        ]
      },
      valueCodeableConcept: {
    ...
    },
    {
      ...
      _effectiveDateTime: {
        extension: [
          {
            url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
            valueString: "item.where(linkId='bp-newbp-date').answer.value.toDateTime()"
          }
        ]
      },
      component: [
              ...
              extension: [
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtractValue',
                  valueString:
                    "%resource.repeat(item).where(linkId='bp-newbp-diastolic').answer.value.toDecimal()"
                }
              ]
            },
            unit: 'mm[Hg]',
  ...
  extension: [
    ...
    },
    {
      ...
      valueCanonical: 'http://www.health.gov.au/assessments/mbs/715/AboutTheHealthCheck|0.3.0'
    },
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
    ...
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
      valueCanonical: 'http://www.health.gov.au/assessments/mbs/715/RegularMedications|0.3.0'
    },
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
      valueCanonical: 'http://www.health.gov.au/assessments/mbs/715/AllergiesAdverseReactions|0.3.0'
    },
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
    ...
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
      valueCanonical: 'http://www.health.gov.au/assessments/mbs/715/SocialHistoryChild|0.3.0'
    },
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
    ...
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
      valueCanonical: 'http://www.health.gov.au/assessments/mbs/715/LearningAndDevelopment|0.3.0'
    },
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
    ...
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
      valueCanonical: 'http://www.health.gov.au/assessments/mbs/715/ChronicDiseaseAgeing|0.3.0'
    },
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
    ...
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
      valueCanonical: 'http://www.health.gov.au/assessments/mbs/715/EarHealthAndHearing|0.3.0'
    },
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
      valueCanonical: 'http://www.health.gov.au/assessments/mbs/715/OralAndDentalHealth|0.3.0'
    },
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
    ...
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
      valueCanonical: 'http://www.health.gov.au/assessments/mbs/715/HealthPrioritiesSummary|0.3.0'
    },
    {
      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-assembledFrom',
      valueCanonical: 'http://www.health.gov.au/assessments/mbs/715/FinalisingHealthCheck|0.3.0'
    }
  ],
      ...
      extension: [
        ...
        },
        {
          ...
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%MedicationStatement.entry.resource.contained.where(id in %MedicationStatement.entry.resource.medication.select(reference.replace('#', '')))"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%MedicationStatement.entry.resource.where(id in %MedicationStatement.entry.resource.medication.select(reference.replace('Medication/', '')))"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
        ...
        },
        {
          ...
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsTobaccoSmokingStatusLatest.value.coding.where(system='http://snomed.info/sct').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
        ...
        },
        {
          ...
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsWaistCircumference.entry.resource.where(status = 'final' or status = 'amended' or status = 'corrected').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsHeartRate.entry.resource.where(status = 'final' or status = 'amended' or status = 'corrected').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsHeartRhythm.entry.resource.where(status = 'final' or status = 'amended' or status = 'corrected').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsBodyHeight.entry.resource.where(status = 'final' or status = 'amended' or status = 'corrected').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsBodyWeight.entry.resource.where(status = 'final' or status = 'amended' or status = 'corrected').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsHeadCircumference.entry.resource.where(status = 'final' or status = 'amended' or status = 'corrected').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
        ...
        },
        {
          ...
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsBodyHeightDateString.substring(8,2).toInteger().toString() + ' ' + %ObsBodyHeightDateString.substring(5,2).replace('01','Jan').replace('02','Feb').replace('03','Mar').replace('04','Apr').replace('05','May').replace('06','Jun').replace('07','Jul').replace('08','Aug').replace('09','Sep').replace('10','Oct').replace('11','Nov').replace('12','Dec') + ' ' + %ObsBodyHeightDateString.substring(0,4)"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
        ...
        },
        {
          ...
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsHeartRateDateString.substring(8,2).toInteger().toString() + ' ' + %ObsHeartRateDateString.substring(5,2).replace('01','Jan').replace('02','Feb').replace('03','Mar').replace('04','Apr').replace('05','May').replace('06','Jun').replace('07','Jul').replace('08','Aug').replace('09','Sep').replace('10','Oct').replace('11','Nov').replace('12','Dec') + ' ' + %ObsHeartRateDateString.substring(0,4)"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsHeartRhythmLatest.value.coding.where(system='http://snomed.info/sct').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
        ...
        },
        {
          ...
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsHeartRhythmDateString.substring(8,2).toInteger().toString() + ' ' + %ObsHeartRhythmDateString.substring(5,2).replace('01','Jan').replace('02','Feb').replace('03','Mar').replace('04','Apr').replace('05','May').replace('06','Jun').replace('07','Jul').replace('08','Aug').replace('09','Sep').replace('10','Oct').replace('11','Nov').replace('12','Dec') + ' ' + %ObsHeartRhythmDateString.substring(0,4)"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsBloodPressureLatest.component.where(code.coding.exists(code='8480-6')).value.value.round(0).toString() + ' / ' + %ObsBloodPressureLatest.component.where(code.coding.exists(code='8462-4')).value.value.round(0).toString()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
        ...
        },
        {
          ...
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "item.where(linkId='c587e3b6-b91a-40dc-9a16-179342d001e9').item.where(linkId='53d5d5a6-3198-4bec-92ac-03fe7d77fb68').item.where(linkId='97ed4c86-8820-4e4d-9234-0e0e8b6ca44a').item.where(linkId='obs-weight-newresult').answer.value"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "item.where(linkId='c587e3b6-b91a-40dc-9a16-179342d001e9').item.where(linkId='53d5d5a6-3198-4bec-92ac-03fe7d77fb68').item.where(linkId='6226a5c5-b5c3-4ebb-a689-2b286322cfe0').item.where(linkId='obs-height-newresult').answer.value"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
        ...
        },
        {
          ...
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsTotalCholesterol.entry.resource.where(status = 'final' or status = 'amended' or status = 'corrected').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%ObsHDLCholesterol.entry.resource.where(status = 'final' or status = 'amended' or status = 'corrected').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
        ...
        },
        {
          ...
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%CVDRiskResult.entry.resource.where(status = 'final' or status = 'amended' or status = 'corrected').first()"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
        ...
        },
        {
          ...
          valueExpression: {
            ...
            language: 'text/fhirpath',
            expression:
              "%CVDRiskResultDateString.substring(8,2).toInteger().toString() + ' ' + %CVDRiskResultDateString.substring(5,2).replace('01','Jan').replace('02','Feb').replace('03','Mar').replace('04','Apr').replace('05','May').replace('06','Jun').replace('07','Jul').replace('08','Aug').replace('09','Sep').replace('10','Oct').replace('11','Nov').replace('12','Dec') + ' ' + %CVDRiskResultDateString.substring(0,4)"
          }
        },
        {
          url: 'http://hl7.org/fhir/StructureDefinition/variable',
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      "%QuestionnaireResponseLatest.entry.resource.where(status='in-progress').exists()"
                  }
                }
              ],
                ...
                extension: [
                  {
                    url: 'http://hl7.org/fhir/StructureDefinition/rendering-xhtml',
                    valueString:
                      '<div xmlns="http://www.w3.org/1999/xhtml"><em>This section contains several read only, non-editable items. Updates to these items will need to be done in the patient record. The form can be repopulated to include any updates.</em></div>'
                  }
                ]
              },
              type: 'display'
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      "(%patient.name.where(use='official').select((family | (given | prefix).join(' ')).join(', ').where($this != '') | text) | %patient.name.select((family | (given | prefix).join(' ')).join(', ').where($this != '') | text)).first()"
                  }
                }
              ],
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      "(%patient.name.where(use='usual').select((family | (given | prefix).join(' ')).join(', ').where($this != '') | text)).first()"
                  }
                }
              ],
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    ...
                    language: 'text/fhirpath',
                    expression:
                      "%patient.address.where(all(use='home' and (type.empty() or type!='postal')))"
                  }
                }
              ],
                  ...
                  extension: [
                    {
                      ...
                      valueExpression: {
                        language: 'text/fhirpath',
                        expression:
                          "%patient.identifier.where(type.coding.exists(system='http://terminology.hl7.org/CodeSystem/v2-0203' and code='MC')).value.substring(0,10)"
                      }
                    },
                    {
                      url: 'http://hl7.org/fhir/StructureDefinition/regex',
                  ...
                  extension: [
                    {
                      ...
                      valueExpression: {
                        language: 'text/fhirpath',
                        expression:
                          "%patient.identifier.where(type.coding.exists(system='http://terminology.hl7.org/CodeSystem/v2-0203' and code='MC')).value.substring(10,1)"
                      }
                    },
                    {
                      url: 'http://hl7.org/fhir/StructureDefinition/regex',
                  ...
                  extension: [
                    {
                      ...
                      valueExpression: {
                        language: 'text/fhirpath',
                        expression:
                          "%patient.identifier.where(type.coding.exists(system='http://terminology.hl7.org/CodeSystem/v2-0203' and code='MC')).period.end.toString()"
                      }
                    }
                  ],
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      "%patient.identifier.where(type.coding.exists(system='http://terminology.hl7.org/CodeSystem/v2-0203' and code='HC')).value"
                  }
                }
              ],
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      "%patient.extension.where(url='http://hl7.org.au/fhir/StructureDefinition/closing-the-gap-registration').value"
                  }
                }
              ],
                  ...
                  extension: [
                    {
                      ...
                      valueExpression: {
                        ...
                        language: 'text/fhirpath',
                        expression:
                          '%MedicationStatement.entry.resource.ofType(MedicationStatement)'
                      }
                    },
                    {
                      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtract',
                  ...
                  extension: [
                    {
                      ...
                      valueExpression: {
                        ...
                        language: 'text/fhirpath',
                        expression:
                          "%AllergyIntolerance.entry.resource.where(clinicalStatus.coding.exists(code='active')).where(verificationStatus.coding.all(code.empty() or code='confirmed'))"
                      }
                    },
                    {
                      url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtract',
              ...
              item: [
                ...
                },
                {
                  ...
                  answerOption: [
                    {
                      valueString:
                        'When playing with toys tends to bang, drop, or throw them rather than use them for their purpose (e.g. cuddle doll, build blocks)'
                    }
                  ]
                },
                {
                ...
                },
                {
                  ...
                  answerOption: [
                    ...
                    {
                      valueString:
                        "Not able to follow directions with two steps (e.g. 'Put your bag away and then go play')"
                    }
                  ]
                },
                {
                  ...
                  answerOption: [
                    ...
                    {
                      valueString:
                        "Not able to answer questions in a simple conversation (e.g. What's your name? Who is your family?)"
                    }
                  ]
                },
                {
                ...
                },
                {
                  ...
                  answerOption: [
                    {
                      valueString:
                        'No form of independent mobility (e.g. crawling, commando crawling, bottom shuffle)'
                    },
                    {
                            ...
                            extension: [
                              {
                                ...
                                valueExpression: {
                                  language: 'text/fhirpath',
                                  expression:
                                    "iif(%ObsTobaccoSmokingStatusValue.exists() and %ObsTobaccoSmokingStatusDateFormatted.exists(), %ObsTobaccoSmokingStatusValue.display + ' ( ' + %ObsTobaccoSmokingStatusDateFormatted + ' )', 'Not available')"
                                }
                              }
                            ]
                          },
                ...
                extension: [
                  {
                    url: 'http://hl7.org/fhir/StructureDefinition/rendering-xhtml',
                    valueString:
                      '<div xmlns="http://www.w3.org/1999/xhtml"><p style="font-size:0.9em; font-weight:normal"><em>The tabled observations will display the most recent results available from the patient record. New observations may be added.</em></p></div>'
                  }
                ]
              },
              type: 'group',
                      ...
                      extension: [
                        {
                          ...
                          valueExpression: {
                            language: 'text/fhirpath',
                            expression:
                              "iif(%resource.repeat(item).where(linkId='obs-lengthheight-newresult').answer.value.exists(), today())"
                          }
                        }
                      ],
                      ...
                      extension: [
                        {
                          ...
                          valueExpression: {
                            language: 'text/fhirpath',
                            expression:
                              "iif(%resource.repeat(item).where(linkId='obs-height-newresult').answer.value.exists(), today())"
                          }
                        }
                      ],
                      ...
                      extension: [
                        {
                          ...
                          valueExpression: {
                            language: 'text/fhirpath',
                            expression:
                              "iif(%resource.repeat(item).where(linkId='obs-weight-newresult').answer.value.exists(), today())"
                          }
                        }
                      ],
                        ...
                        extension: [
                          {
                            ...
                            valueExpression: {
                              language: 'text/fhirpath',
                              expression:
                                "iif(%ObsBodyWeightValue.exists() and %ObsBodyHeightValue.exists(), (%ObsBodyWeightValue/((%ObsBodyHeightValue/100).power(2))).round(1).toString() + ' kg/m2', 'Not available')"
                            }
                          },
                          {
                            url: 'http://hl7.org/fhir/StructureDefinition/rendering-style',
                        ...
                        extension: [
                          {
                            ...
                            valueExpression: {
                              language: 'text/fhirpath',
                              expression:
                                "iif(%ObsHeadCircumferenceValue.exists() and %ObsHeadCircumferenceDateFormatted.exists(), %ObsHeadCircumferenceValue.round(0).toString() + ' cm ( ' + %ObsHeadCircumferenceDateFormatted + ' )', 'Not available')"
                            }
                          },
                          {
                            url: 'http://hl7.org/fhir/StructureDefinition/rendering-style',
                      ...
                      extension: [
                        {
                          ...
                          valueExpression: {
                            language: 'text/fhirpath',
                            expression:
                              "iif(%resource.repeat(item).where(linkId='obs-headcircumference-newresult').answer.value.exists(), today())"
                          }
                        }
                      ],
                      ...
                      extension: [
                        {
                          ...
                          valueExpression: {
                            language: 'text/fhirpath',
                            expression:
                              "iif(%resource.repeat(item).where(linkId='obs-waistcircumference-newresult').answer.value.exists(), today())"
                          }
                        }
                      ],
                        ...
                        extension: [
                          {
                            ...
                            valueExpression: {
                              language: 'text/fhirpath',
                              expression:
                                "iif(%ObsHeartRateValue.exists() and %ObsHeartRateDateFormatted.exists(), %ObsHeartRateValue.round(0).toString() + ' /min ( ' + %ObsHeartRateDateFormatted + ' )', 'Not available')"
                            }
                          },
                          {
                            url: 'http://hl7.org/fhir/StructureDefinition/rendering-style',
                      ...
                      extension: [
                        {
                          ...
                          valueExpression: {
                            language: 'text/fhirpath',
                            expression:
                              "iif(%resource.repeat(item).where(linkId='obs-heartrate-newresult').answer.value.exists(), today())"
                          }
                        }
                      ],
                        ...
                        extension: [
                          {
                            ...
                            valueExpression: {
                              language: 'text/fhirpath',
                              expression:
                                "iif(%ObsHeartRhythmValue.exists() and %ObsHeartRhythmDateFormatted.exists(), %ObsHeartRhythmValue.display + ' ( ' + %ObsHeartRhythmDateFormatted + ' )', 'Not available')"
                            }
                          },
                          {
                            url: 'http://hl7.org/fhir/StructureDefinition/rendering-style',
                      ...
                      extension: [
                        {
                          ...
                          valueExpression: {
                            language: 'text/fhirpath',
                            expression:
                              "iif(%resource.repeat(item).where(linkId='obs-heartrhythm-newresult').answer.value.exists(), today())"
                          }
                        }
                      ],
                        ...
                        extension: [
                          {
                            ...
                            valueExpression: {
                              language: 'text/fhirpath',
                              expression:
                                "iif(%ObsBloodPressureValue.exists() and %ObsBloodPressureDateFormatted.exists(), %ObsBloodPressureValue + ' mm Hg ( ' + %ObsBloodPressureDateFormatted + ' )', 'Not available')"
                            }
                          },
                          {
                            url: 'http://hl7.org/fhir/StructureDefinition/rendering-style',
                      ...
                      extension: [
                        {
                          ...
                          valueExpression: {
                            language: 'text/fhirpath',
                            expression:
                              "iif(%resource.repeat(item).where(linkId='bp-newbp-systolic').answer.value.exists() or %resource.repeat(item).where(linkId='bp-newbp-diastolic').answer.value.exists(), today())"
                          }
                        }
                      ],
                ...
                extension: [
                  {
                    url: 'http://hl7.org/fhir/StructureDefinition/rendering-xhtml',
                    valueString:
                      '<div xmlns="http://www.w3.org/1999/xhtml"><p style="font-size:1.1em;">The Australian guideline for assessing and managing cardiovascular disease risk recommends the use of the Aus&nbsp;CVD&nbsp;Risk calculator.</p></div>'
                  }
                ]
              },
              type: 'display'
                  ...
                  extension: [
                    {
                      ...
                      valueExpression: {
                        language: 'text/fhirpath',
                        expression:
                          "iif(%CVDRiskResultValue.exists() and %CVDRiskResultDateFormatted.exists(), %CVDRiskResultValue + ' ( ' + %CVDRiskResultDateFormatted + ' )', 'Not available')"
                      }
                    }
                  ],
                  ...
                  extension: [
                    {
                      ...
                      valueExpression: {
                        language: 'text/fhirpath',
                        expression:
                          '%CVDRiskResultValue.exists() and %CVDRiskResultDateFormatted.exists()'
                      }
                    }
                  ],
                  ...
                  extension: [
                    {
                      ...
                      valueExpression: {
                        language: 'text/fhirpath',
                        expression:
                          '%NewAssessmentQuestionAnswer = true or %CVDRiskResultValue.empty() or %CVDRiskResultDateFormatted.empty()'
                      }
                    }
                  ],
                    ...
                    extension: [
                      {
                        url: 'http://hl7.org/fhir/StructureDefinition/rendering-xhtml',
                        valueString:
                          '<div xmlns="http://www.w3.org/1999/xhtml"><p style="font-size:1.1em;">Using the <em>Aus&nbsp;CVD&nbsp;Risk&#8209;i</em> application, calculate the CVD risk result and save it to the patient record. This form can then be repopulated to retrieve and include the result above.</p></div>'
                      }
                    ]
                  },
                  type: 'display'
                  ...
                  extension: [
                    {
                      ...
                      valueExpression: {
                        language: 'text/fhirpath',
                        expression:
                          '%AusCVDRiskiAccessAnswer != true or %RepopulateOverrideAnswer = true'
                      }
                    }
                  ],
                        ...
                        extension: [
                          {
                            url: 'http://hl7.org/fhir/StructureDefinition/rendering-xhtml',
                            valueString:
                              '<div xmlns="http://www.w3.org/1999/xhtml"><p>The <a href="https://www.cvdcheck.org.au/calculator" target="_blank">Australian CVD risk calculator</a> on the Aus&nbsp;CVD&nbsp;Risk website should be used. Below is a read only view of a subset of variables that can be used as inputs for the online calculator. The calculated CVD risk result can be entered here.</p></div>'
                          }
                        ]
                      },
                      type: 'display'
                          ...
                          extension: [
                            {
                              ...
                              valueExpression: {
                                language: 'text/fhirpath',
                                expression:
                                  "%ObsBloodPressureLatest.component.where(code.coding.exists(code='8480-6')).value.value"
                              }
                            },
                            {
                              url: 'http://hl7.org/fhir/StructureDefinition/questionnaire-unit',
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      '%age > 12 and %HealthPrioritiesSummarySocialEmotionalWellbeing.exists()'
                  }
                },
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-calculatedExpression',
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      '%age <= 12 and %HealthPrioritiesSummaryLearningDevelopment.exists()'
                  }
                },
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-calculatedExpression',
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      '(%age > 12) and (%age < 50) and %HealthPrioritiesSummaryLearningWorkAdults.exists()'
                  }
                },
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-calculatedExpression',
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      '%age >= 50 and %HealthPrioritiesSummaryChronicDiseaseAgeing.exists()'
                  }
                },
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-calculatedExpression',
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      '(%age >= 50) and (%age <= 74) and %HealthPrioritiesSummaryScreeningPrograms.exists()'
                  }
                },
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-calculatedExpression',
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      '%age < 50 and %HealthPrioritiesSummaryPhysicalActivityScreenTimeNotOlder.exists()'
                  }
                },
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-calculatedExpression',
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      '%age >= 50 and %HealthPrioritiesSummaryPhysicalActivityScreenTimeOlder.exists()'
                  }
                },
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-calculatedExpression',
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      '(%age > 12) and (%age <= 24) and %HealthPrioritiesSummarySexualHealthAdolescents.exists()'
                  }
                },
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-calculatedExpression',
              ...
              extension: [
                {
                  ...
                  valueExpression: {
                    language: 'text/fhirpath',
                    expression:
                      '(%age > 24) and (%age <= 49) and %HealthPrioritiesSummarySexualHealthAdults.exists()'
                  }
                },
                {
                  url: 'http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-calculatedExpression',
