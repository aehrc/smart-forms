...
interface UseDateCalculatedExpressionReturn {
  calcExpUpdated: boolean;
}

interface UseDateCalculatedExpressionProps {
  qItem: QuestionnaireItem;
  valueDateFhir: string;
  onChangeByCalcExpressionString: (newValueDateFhir: string) => void;
  onChangeByCalcExpressionNull: () => void;
}

function useDateCalculatedExpression(
  props: UseDateCalculatedExpressionProps
): UseDateCalculatedExpressionReturn {
  const { qItem, valueDateFhir, onChangeByCalcExpressionString, onChangeByCalcExpressionNull } =
    props;
