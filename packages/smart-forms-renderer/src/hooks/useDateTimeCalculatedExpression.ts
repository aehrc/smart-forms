...
interface UseDateTimeCalculatedExpressionReturn {
  calcExpUpdated: boolean;
}

interface UseDateTimeCalculatedExpressionProps {
  qItem: QuestionnaireItem;
  valueDateTimeFhir: string;
  onChangeByCalcExpressionString: (newValueDateTimeFhir: string) => void;
  onChangeByCalcExpressionNull: () => void;
}

function useDateTimeCalculatedExpression(
  props: UseDateTimeCalculatedExpressionProps
): UseDateTimeCalculatedExpressionReturn {
  const { qItem, valueDateTimeFhir, onChangeByCalcExpressionString, onChangeByCalcExpressionNull } =
    props;
