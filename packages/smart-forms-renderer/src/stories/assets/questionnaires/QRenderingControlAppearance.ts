...
export const qWidthGTable: Questionnaire = {
  resourceType: 'Questionnaire',
  status: 'draft',
  item: [
    {
      linkId: 'table-layout',
      text: 'Table Layout with Width Extension',
      type: 'group',
      repeats: true,
      extension: [
        {
...
export const qWidthGrid: Questionnaire = {
  resourceType: 'Questionnaire',
  status: 'draft',
  item: [
    {
      linkId: 'grid-layout',
      text: 'Grid Layout with Width Extension',
      type: 'group',
      repeats: false,
      extension: [
        {
