...
import { SmartClientContextForStorybook } from './SmartClientContextForStorybook';
...
function useSmartClientForStorybook() {
  const { state, dispatch } = useContext(SmartClientContextForStorybook);
...
export default useSmartClientForStorybook;
