...
describe('parseValidInteger', () => {
  ...
  it('should parse strings with leading/trailing spaces', () => {
    expect(parseValidInteger(' 123 ')).toBe(123);
...
describe('parseValidNumericString', () => {
  it('should return original string if it contains numbers', () => {
  ...
  it('should return "0" if string contains no numbers', () => {
...
describe('parseIntegerString', () => {
  ...
  it('should truncate decimal parts', () => {
...
describe('parseDecimalStringWithPrecision', () => {
  ...
  it('should parse valid decimal strings without precision limit', () => {
  ...
  it('should preserve decimal digits when parseFloat removes them', () => {
  ...
  it('should handle mixed alphanumeric with precision', () => {
...
describe('parseDecimalStringToFloat', () => {
  it('should parse valid decimal strings with precision', () => {
