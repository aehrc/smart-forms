...
describe('Parent/primary caregiver present question', () => {
  test('for yes', async () => {
    ...
    await checkRadioOption(
      container,
      'Parent/primary caregiver is present for health check?',
      'Yes'
    );
  ...
  test('for no', async () => {
    ...
    await expect(
      async () => await findByLinkIdOrLabel(container, 'Relationship to child')
    ).rejects.toThrow();
  });
...
describe('Children question', () => {
  ...
  test('for no', async () => {
    ...
    await expect(
      async () => await findByLinkIdOrLabel(container, 'Number of children')
    ).rejects.toThrow();
  });
...
describe("Someone's carer question", () => {
  ...
  test('for no', async () => {
    ...
    await expect(
      async () => await findByLinkIdOrLabel(container, '4c14b158-3ae4-4994-8446-76e02640702c')
    ).rejects.toThrow();
  });
...
describe('Your carer question', () => {
  ...
  test('for no', async () => {
    ...
    const yourCarerContainer = await findByLinkIdOrLabel(container, 'Your carer');
    await expect(
      async () => await findByLinkIdOrLabel(yourCarerContainer, 'Details')
    ).rejects.toThrow();
  });
...
describe('Child Health Book question', () => {
  ...
  test('for no', async () => {
    ...
    await expect(
      async () => await findByLinkIdOrLabel(container, 'Is it up to date?')
    ).rejects.toThrow();
  });
});
...
describe('Red flags early identification guide for children question', () => {
  ...
  test('for 12 months Communication', async () => {
    ...
    await checkCheckboxOption(
      container,
      'Communication',
      'No response to familiar words (e.g. bottle, daddy)'
    );
  });
  ...
  test('for 2 years Gross motor', async () => {
    ...
    await checkCheckboxOption(
      container,
      'Gross motor',
      'Not able to walk up and down stairs holding on'
    );
  });
  ...
  test('for 4 years Gross motor', async () => {
    ...
    await checkCheckboxOption(
      container,
      'Gross motor',
      'Not able to walk, run, climb, jump and uses stairs confidently'
    );
  });
...
describe('Genitourinary and sexual health question', () => {
  ...
  test('for no', async () => {
    ...
    await expect(
      async () => await findByLinkIdOrLabel(sexualHealthContainer, 'Details')
    ).rejects.toThrow();
  });
