 ...
 */
interface IonBinocularsIconProps {
  width?: number;
  height?: number;
}

// Lifted from Iconify ion:binoculars
function IonBinocularsIcon(props: IonBinocularsIconProps) {
...
export default IonBinocularsIcon;
