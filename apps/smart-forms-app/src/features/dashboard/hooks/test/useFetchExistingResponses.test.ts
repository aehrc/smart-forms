...
import useFetchExistingResponses from '../useFetchExistingResponses.ts';
...
jest.mock('../useSelectedQuestionnaire.ts', () => ({
  __esModule: true,
  default: jest.fn()
}));
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const mockUseSelectedQuestionnaire = (jest.requireMock('../useSelectedQuestionnaire.ts') as any)
