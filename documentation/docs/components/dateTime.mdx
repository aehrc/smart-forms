...
<IframeContainer storyUrl="https://smartforms.csiro.au/storybook/index.html?path=/story/component-itemtype-datetime--date-time-basic">
  <iframe
...
<IframeContainer storyUrl="https://smartforms.csiro.au/storybook/index.html?path=/story/component-itemtype-datetime--date-time-basic-response">
  <iframe
