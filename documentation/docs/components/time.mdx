...
<IframeContainer storyId="itemtype-time--time-basic" initialHeight={128} />

#### With Response

<IframeContainer storyId="itemtype-time--time-basic-response" initialHeight={128} />

### Advanced usage

#### Calculations

<IframeContainer storyId="sdc-10-1-3-behavior-calculations-item-type-calculations--time-calculation" initialHeight={180} />
