...
<IframeContainer
  storyId="csiro-renderer-itemtype-openchoice--open-choice-answer-option-basic"
  initialHeight={252}
/>
...
<IframeContainer
  storyId="csiro-renderer-itemtype-openchoice--open-choice-answer-option-basic-response"
  initialHeight={252}
/>
...
<IframeContainer
  storyId="csiro-renderer-itemtype-openchoice--open-choice-answer-value-set-basic"
  initialHeight={456}
/>
...
<IframeContainer
  storyId="csiro-renderer-itemtype-openchoice--open-choice-answer-value-set-basic-response"
  initialHeight={456}
/>
