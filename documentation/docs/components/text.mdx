...
<IframeContainer storyId="itemtype-text--text-basic" initialHeight={190} />

#### With Response

<IframeContainer storyId="itemtype-text--text-basic-response" initialHeight={190} />

:::tip

Pressing the enter key in the text input component increases its height.
...
<IframeContainer storyId="sdc-10-1-3-behavior-calculations-item-type-calculations--text-calculation" initialHeight={860} />
