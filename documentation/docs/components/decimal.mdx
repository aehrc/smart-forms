...
<IframeContainer storyId="itemtype-decimal--decimal-basic" initialHeight={120} />

#### With Response

<IframeContainer storyId="itemtype-decimal--decimal-basic-response" initialHeight={120} />

### Advanced usage

#### Calculations

<IframeContainer storyId="itemtype-decimal--decimal-calculation" initialHeight={352} />
