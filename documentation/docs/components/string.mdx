...
<IframeContainer storyId="csiro-renderer-itemtype-string--string-basic" initialHeight={120} />

#### With Response

<IframeContainer
  storyId="csiro-renderer-itemtype-string--string-basic-response"
  initialHeight={120}
/>
...
<IframeContainer storyId="csiro-renderer-itemtype-string--string-calculation" initialHeight={280} />
