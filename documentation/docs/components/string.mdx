...
<IframeContainer storyId="itemtype-string--string-basic" initialHeight={120} />

#### With Response

<IframeContainer storyId="itemtype-string--string-basic-response" initialHeight={120} />

### Advanced usage

#### Calculations

<IframeContainer storyId="sdc-10-1-3-behavior-calculations-item-type-calculations--string-calculation" initialHeight={280} />
