...
<IframeContainer storyId="itemtype-integer--integer-basic" initialHeight={140} />

#### With Response

<IframeContainer storyId="itemtype-integer--integer-basic-response" initialHeight={140} />

### Advanced usage

#### Calculations

<IframeContainer storyId="sdc-10-1-3-behavior-calculations-item-type-calculations--integer-calculation" initialHeight={190} />
