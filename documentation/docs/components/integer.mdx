...
<IframeContainer storyId="csiro-renderer-itemtype-integer--integer-basic" initialHeight={120} />

#### With Response

<IframeContainer
  storyId="csiro-renderer-itemtype-integer--integer-basic-response"
  initialHeight={120}
/>
...
<IframeContainer
  storyId="csiro-renderer-itemtype-integer--integer-calculation"
  initialHeight={180}
/>
