...
<IframeContainer storyId="csiro-renderer-itemtype-quantity--quantity-basic" initialHeight={280} />

#### With Response

<IframeContainer
  storyId="csiro-renderer-itemtype-quantity--quantity-basic-response"
  initialHeight={280}
/>
...
<IframeContainer
  storyId="csiro-renderer-itemtype-quantity--quantity-unit-option-response"
  initialHeight={280}
/>
...
<IframeContainer
  storyId="csiro-renderer-itemtype-quantity--quantity-calculation"
  initialHeight={280}
/>
