...
<IframeContainer
  storyId="itemtype-quantity--quantity-basic-response"
  initialHeight={280}
/>
...
<IframeContainer
  storyId="itemtype-quantity--quantity-unit-option-response"
  initialHeight={280}
/>

#### Calculations

<IframeContainer storyId="itemtype-quantity--quantity-calculation" initialHeight={280} />
