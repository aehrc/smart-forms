...
The sourceResponse does not change when the form gets edited - that is where the [`updatableResponse`](/docs/dev/storehooks/questionnaire-response-store/updatable-response) comes in.
