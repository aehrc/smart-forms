...
<IframeContainer
  storyId="csiro-renderer-sdc-9-1-1-form-behavior-value-constraints--max-length"
  initialHeight={272}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-9-1-1-form-behavior-value-constraints--min-length"
  initialHeight={272}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-9-1-1-form-behavior-value-constraints--regex"
  initialHeight={272}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-9-1-1-form-behavior-value-constraints--min-value"
  initialHeight={272}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-9-1-1-form-behavior-value-constraints--max-value"
  initialHeight={272}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-9-1-1-form-behavior-value-constraints--max-decimal-places"
  initialHeight={272}
/>
