...
<IframeContainer
  storyId="sdc-8-1-4-advanced-other--repeats-autocomplete"
  initialHeight={280}
/>
...
<IframeContainer
  storyId="sdc-8-1-4-advanced-other--repeats-checkbox"
  initialHeight={216}
/>
...
<IframeContainer
  storyId="sdc-8-1-4-advanced-other--repeats-group-nested"
  initialHeight={1140}
/>
...
<IframeContainer
  storyId="sdc-8-1-1-advanced-text-appearance--hidden"
  initialHeight={120}
/>
