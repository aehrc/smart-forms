...
<IframeContainer
  storyId="csiro-renderer-sdc-8-1-2-advanced-control-appearance-item-control-group--g-table-single"
  initialHeight={528}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-8-1-2-advanced-control-appearance-item-control-group--g-table-repeats"
  initialHeight={580}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-8-1-2-advanced-control-appearance-item-control-group--grid-single-row"
  initialHeight={268}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-8-1-2-advanced-control-appearance-item-control-group--grid-multi-row"
  initialHeight={580}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-8-1-2-advanced-control-appearance-item-control-group--tab-container"
  initialHeight={564}
/>
