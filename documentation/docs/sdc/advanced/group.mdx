...
<IframeContainer
  storyId="sdc-9-1-2-rendering-control-appearance-itemcontrol-group--g-table-single"
  initialHeight={520}
/>
...
<IframeContainer
  storyId="sdc-9-1-2-rendering-control-appearance-itemcontrol-group--g-table-repeats"
  initialHeight={580}
/>
...
<IframeContainer
  storyId="sdc-9-1-2-rendering-control-appearance-itemcontrol-group--grid-single-row"
  initialHeight={270}
/>
...
<IframeContainer
  storyId="sdc-9-1-2-rendering-control-appearance-itemcontrol-group--grid-multi-row"
  initialHeight={580}
/>
...
Indicates that the group represents a page in the questionnaire.

This can be used to create a multi-page form, with each page representing a section of the form.

#### Basic Usage

<IframeContainer
  storyId="sdc-9-1-2-rendering-control-appearance-itemcontrol-group--page"
  initialHeight={410}
/>
...
<IframeContainer
  storyId="sdc-9-1-2-rendering-control-appearance-itemcontrol-group--tab-container"
  initialHeight={500}
/>
