...
<IframeContainer
  storyId="csiro-renderer-sdc-9-1-3-form-behavior-calculations--calculated-expression-bmi-calculator"
  initialHeight={352}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-9-1-3-form-behavior-calculations--calculated-expression-cvd-risk-calculator"
  initialHeight={1168}
/>
