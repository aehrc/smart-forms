...
<IframeContainer
  storyId="sdc-14-form-population--item-population-context-home-address"
  initialHeight={760}
/>
...
<IframeContainer
  storyId="sdc-14-form-population--item-population-context-medical-history"
  initialHeight={630}
/>
...
<IframeContainer storyId="sdc-10-1-4-behavior-other-control--initial-repeats" initialHeight={500} />
...
<IframeContainer storyId="sdc-14-form-population--initial-expression" initialHeight={150} />
...
<IframeContainer
  storyId="sdc-14-form-population--calculated-expression-bmi-calculator-prepop"
  initialHeight={350}
/>
...
<IframeContainer
  storyId="sdc-14-form-population--calculated-expression-cvd-risk-calculator-prepop"
  initialHeight={1070}
/>
