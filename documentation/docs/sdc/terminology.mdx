...
<IframeContainer
  storyId="csiro-renderer-sdc-9-1-2-form-behavior-choice-restriction--answer-expression"
  initialHeight={280}
/>
...
<IframeContainer
  storyId="csiro-renderer-sdc-other-extensions--preferred-terminology-server"
  initialHeight={280}
/>
