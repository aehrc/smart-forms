...
Allows dynamically enabling or disabling answer options based on FHIRPath expressions. This extension provides conditional visibility of answer options based on the current form state.

#### Basic usage

<IframeContainer
  storyId="sdc-9-1-2-form-behavior-choice-restriction--answer-option-toggle-expression-answer-option"
  initialHeight={280}
/>

#### With contained ValueSet

<IframeContainer
  storyId="sdc-9-1-2-form-behavior-choice-restriction--answer-option-toggle-expression-answer-value-set-contained"
  initialHeight={280}
/>
