...
Refer to the [API Reference](/docs/api/sdc-populate/functions/populateQuestionnaire) to view function parameters.

For usage examples, refer to [this example BaseRenderer wrapper](/docs/dev/renderer-overview#pre-population-usage).
