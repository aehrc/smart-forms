...
For more information on store hooks or stores in general, refer to ...
...
You've completed the first page on how to use the renderer!
Next steps from here is to learn how to use other store hooks just like `useQuestionnaireResponseStore.use.updatableResponse()`.

[//]: # 'TODO validation'
[//]: # 'TODO all hooks'
[//]: # 'destroy form'
[//]: # 'remove hidden answers from response before saving'
[//]: # 'deprecation of smart forms renderer'
[//]: # 'i think actually walk through their API'
